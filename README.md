...
I’m using Django with version 2.1.3. You can install it by run this on your terminal.

	pip install django

`Installing Kubernetes`

I’m using Kubernetes with version 8.0.1. You can install it by run this on your terminal.

	pip install kubernetes

`Installing Yaml`

Don’t know why, the ordinary yaml didn’t work for me due to version problem or something. So, Im using PyYAML (some YAML for python I guess) with version 3.13 instead. You can install it by run this on your terminal.
